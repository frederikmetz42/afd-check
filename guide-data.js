const GUIDE_DATA = [
  ...
  },
  {
    ...
    rebuttal: "Beide Zitate sind komplizierter als sie klingen. Habecks Buch heißt 'Patriotismus: Ein Plädoyer' und argumentiert FÜR Patriotismus. Er beschreibt, wie er gelernt hat, Verantwortung für sein Land zu übernehmen. Der Satz allein klingt anders als das ganze Kapitel. Roth hat das Banner 2002 nicht selbst gehalten. Sie lief bei einer Demo dahinter her und hat sich distanziert. Das Foto kursiert seit 20 Jahren ohne diesen Kontext. Trotzdem: Teile der deutschen Linken tun sich schwer mit Patriotismus. Das ist real. Die Frage ist, ob die AfD-Version die Antwort darauf ist. Man kann stolz auf sein Land sein, ohne SA-Parolen zu benutzen oder den Holocaust als Vogelschiss zu bezeichnen.",
